...
A catalogue of every direction this project could move in, from "actually useful next session" through to "VC-funded delusion". Sorted by tractability. Nothing here is committed to — the user picks what moves out of TODO.
